...
public class MenuScreen implements Screen {
    ...
    private Music menuMusic; // Música do menu
    ...
    public MenuScreen() {
        ...
        menuMusic.setLooping(true); // Define para tocar em loop
        menuMusic.play(); // Inicia a reprodução da música
    }
    ...
    public void render(float delta) {
        ...
        if (Gdx.input.isKeyPressed(Input.Keys.NUM_1)) {
            menuMusic.stop(); // Para a música quando mudar de tela
    ...
    public void dispose() {
        ...
        menuMusic.dispose(); // Libera a música do menu
    }
}
